...
<body>
    ...
    <div class="container-fluid mt-3">
        <div class="row">
            ...
            <div class="col-lg-10">
                <h6 class="lead">Sent</h6>
                <table class="table">
                    <?php 
                        $id = $user['id'];
                        $callingMail = mysqli_query($connect,"select * from mails JOIN accounts ON mails.receiver_id = accounts.id where sender_id='$id' AND status='0' ORDER BY mails.m_id DESC");
