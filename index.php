...
<body>
        ...
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <table class="table">
                    <?php 
                        $id = $user['id'];
                        $callingMail = mysqli_query($connect,"select * from mails JOIN accounts ON mails.sender_id = accounts.id where receiver_id='$id' AND status='0' ORDER BY mails.read_status DESC");
                    ...
                    <tr style="background-color:<?= $color?>">
                        ...
                        <td>
                            ...
                            <span class="float-end">
                                ...
                                ?>
                                <a href="index.php?del_id=<?= $row['m_id'];?>" class=" btn btn-outline-danger btn-sm"><i class='bi bi-trash'></i></a>
    ...
    if(isset($_GET['del_id'])){
        ...
        $query = mysqli_query($connect,"UPDATE mails SET status='-1' WHERE m_id='$id'");
